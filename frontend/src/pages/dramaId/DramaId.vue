    ...
    <div class="drama-page" v-if="drama">
      ...
      <div class="drama-top-info q-pa-md q-mb-lg">
        ...
        <div class="drama-content q-ml-md">
          <div class="text-white text-weight-medium text-h4 q-pt-xs">
            {{ drama.title }}
          </div>
          <div class="text-grey text-weight-medium q-mt-xs">
            {{ drama.episode }}
          </div>
          <div class="text-grey text-weight-medium q-mt-xs">
            {{ drama.rating }}
          ...
          <q-btn
            class="q-mt-sm text-white bg-like"
          ...
          <div>
            ...
            <div class="intro-casts q-mb-lg">
                ...
                <span class="text-weight-bold">
                  <span v-for="(cast, index) in drama.Casts" :key="cast.id">
                    <router-link
                      ...
                      :to="{ name: 'figure-id', params: { id: cast.id } }"
                      >{{ cast.name }}</router-link
                    >
                    <span v-if="index !== drama.Casts.length - 1"
                      >&nbsp;&nbsp;/&nbsp;&nbsp;</span
                    >
                  </span>
              ...
              <div class="intro-casts__item">
                ...
                <span class="text-weight-bold">{{ drama.themes || '--' }}</span>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="q-pa-md">
                <div class="row q-col-gutter-md">
                  <div
                    class="col-4"
                    v-for="series in drama.Series"
                    :key="series.id"
                  >
                    <div class="series-item">
                      <q-img
                        class="drama-img full-height"
                        :src="`${series.img}`"
                      />
                      <div class="series-overlay"></div>
                      <div class="series-content q-pa-sm q-mt-md">
                        <div class="text-white text-weight-medium q-mt-xs">
                          {{ series.title }}
                        </div>
                        <div class="text-white text-weight-medium q-mt-xs">
                          {{ series.time }}
                        ...
                        <button class="play-btn">
                          ...
                          >
                            ...
                            <circle
                              ...
                              stroke-dashoffset="276.46015351590177"
                              r="44"
                              cx="50"
                              cy="50"
                            ></circle>
...
<script lang="ts">
import { DramaDetailType } from '../../components/models'
import { Vue, Component, Watch } from 'vue-property-decorator'
import dramaApi from '../../apis/dramaApi'

@Component
export default class DramaId extends Vue {
  drama = {} as DramaDetailType

  @Watch('$route.params.id', {
    immediate: true,
  })
  onDramaChange() {
    console.log('onDramaChange:')
    this.fetchData()
  }
  ...
  fetchData() {
    dramaApi
      .fetchDramaDetail(this.$route.params.id)
      .then((res) => {
        this.drama = res.data
      })
      .catch((err) => {
